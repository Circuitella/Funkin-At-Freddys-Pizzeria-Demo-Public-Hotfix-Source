...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		portrait = new FlxSprite(0, 0).loadGraphic(Paths.image('freeplay/none'));
		add(portrait);
		...
		for (i in 0...songs.length)
		{
			...
			//add the backround to the song name bs here
	...
	{
		var freeplaySongName:String = songs[curSelected].songName.toLowerCase();

		portrait = new FlxSprite(0, 0).loadGraphic(Paths.image('freeplay/'+ freeplaySongName));
