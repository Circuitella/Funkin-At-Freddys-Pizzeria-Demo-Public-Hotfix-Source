	...
	function startIntro()
	{
		...
		switch(easterEgg.toUpperCase())
		{
			...
			//EDIT THIS ONE IF YOU'RE MAKING A SOURCE CODE MOD!!!!
				...
				fnafstatic = new FlxSprite(0,0);
				fnafstatic.frames = Paths.getSparrowAtlas('fnafstatic');
				fnafstatic.alpha = 0; //doesnt work for some reason, probally need to space it out
				fnafstatic.animation.addByPrefix('fnafstatic', 'fnafstatic', 24, true);
				fnafstatic.animation.play('fnafstatic');
		}
		add(gfDance);
		add(fnafstatic);
		add(logoBl);
